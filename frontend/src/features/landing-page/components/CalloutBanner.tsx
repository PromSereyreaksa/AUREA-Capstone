...
export const CalloutBanner = () => {
  return (
    <section className="bg-[#1a1a1a] pb-24 relative">
      <div className="wide-section">
        <motion.div
          ...
          className="bg-white rounded-4xl border-4 border-white overflow-hidden brutal-shadow-lg"
        >
          {/* Header */}
          <div className="bg-white py-6 text-center border-b-4 border-black">
            <h2 className="text-3xl font-['Archivo_Black']">Made for Designers</h2>
          </div>
          ...
          <div className="relative h-100 overflow-hidden">
            ...
            <div className="absolute inset-0">
              ...
              <div className="absolute bottom-[20%] left-[5%] w-full h-25" 
                   style={{
                     backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 10px, #333 10px, #333 12px)',
                   }}>
              </div>
            ...
            <div className="absolute inset-0 flex items-center justify-start pl-12">
              <div className="max-w-125">
                <h3 className="text-6xl md:text-7xl font-['Archivo_Black'] leading-tight">
                  <span className="text-black">DON'T</span><br/>
                  <span className="text-black">KNOW</span><br/>
                  <span className="text-[#CDDC39] [-webkit-text-stroke:2px_black]" style={{WebkitTextStroke: '2px black'}}>HOW</span><br/>
                  <span className="text-black">MUCH</span><br/>
